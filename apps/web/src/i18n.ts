  ...
  en: {
    translation: {
      ...
      captain: {
        ...
        description:
          'Connect Google Workspace, then provide your assigned class Google Sheet link and your class roll to verify access. This verification is read-only.',
  ...
  bn: {
    translation: {
      ...
      captain: {
        ...
        description:
          'Google Workspace সংযুক্ত করুন, তারপর আপনার নির্ধারিত ক্লাসের Google Sheet লিঙ্ক ও ক্লাস রোল দিন যাচাইয়ের জন্য। এই যাচাইকরণ শুধু read-only।',
